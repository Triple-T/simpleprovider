...
public abstract class AbstractProvider extends ContentProvider {
    ...
    protected Uri makeUriFromSyncAdapter(Uri uri) {
        return uri.buildUpon().appendQueryParameter(QUERY_CALLER_IS_SYNC_ADAPTER, "1").build();
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        if (rowId > -1) {
            getContentResolver().notifyChange(uri, null, !uri.getBooleanQueryParameter(QUERY_CALLER_IS_SYNC_ADAPTER, false));
